	...
	<div class="lg:col-span-2">
		<div class="bg-white rounded-lg shadow-sm border overflow-hidden">
			<div class="px-6 py-4 border-b border-gray-200">
				<h3 class="text-lg font-semibold text-gray-900">School Announcements &amp; Events</h3>
					...
					<div class="p-6 hover:bg-gray-50 transition-colors">
						<div class="flex items-start justify-between">
							<div class="flex-1">
								<div class="flex items-center gap-3 mb-3">
									<div class="flex items-center gap-2">
										<i class="{getTypeIcon(announcement.type)} text-gray-600 size-5"></i>
							...
							<div class="flex items-center space-x-2 ml-4">
								...
								>
									<i class="icon-[mdi--{announcement.is_active ? 'pause' : 'play'}] size-4"></i>
									<span class="sr-only">{announcement.is_active ? 'Deactivate' : 'Activate'}</span>
								</button>
								<button
									type="button"
			...
			<form {...add_announcement}>
				...
				<fieldset class="space-y-6">
					...
					<div>
						...
						<select id="target_audience" name="target_audience" class="select w-full">
					...
					<div>
						...
						<p class="text-xs text-gray-500 mt-1">Leave empty for permanent announcement</p>
					</div>
