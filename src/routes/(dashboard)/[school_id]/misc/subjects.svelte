		...
		<thead class="bg-gray-50">
			<tr>
				<th scope="col" class="px-5 py-3 text-start">
					<span class="font-semibold text-gray-700 capitalize"> Subject Name </span>
				</th>
				<th scope="col" class="px-5 py-3 text-start">
					<span class="font-semibold text-gray-700 capitalize"> Subject Code </span>
				</th>
		...
		<form {...add_subject}>
			...
			<fieldset class="grid gap-4">
				...
				<div class="flex flex-col gap-1">
					...
					<input type="text" id="code" name="code" placeholder="CODE-001" class="input" />
				</div>
