				...
				<div class="overflow-hidden rounded-xl border border-gray-200 bg-white shadow-2xs">
					...
					>
						<div>
							...
							<p class="text-sm text-gray-600">Add staff, view, edit and more...</p>
						</div>
					...
					<table class="table min-w-full divide-y divide-gray-200">
						<thead class="bg-gray-50">
							<tr>
								...
								{@render table_header('Position')}
								{@render table_header('Contact')}
								{@render table_header('Status')}
								{@render table_header('employed on')}
	...
	<tr>
		...
		<td class="size-px whitespace-nowrap">
			<div class="px-6 py-1.5">
				<a class="btn-link text-sm text-blue-600" href="{page.url.pathname}/{staff.id}">
