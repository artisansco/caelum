        ...
        <div class="space-y-6">
          ...
          <article class="rounded-xl border border-gray-200 bg-white p-6 shadow-sm">
            <header class="mb-6 flex items-center gap-3">
              ...
              <h2 class="text-lg font-bold text-gray-900">Employment Details</h2>
            </header>
                ...
                <div class="flex items-center gap-1">
                  ...
                  {#if edit_mode}
                    <button
                      ...
                      class="btn-sm"
                    >
                      <i class={view_password ? "icon-[mdi--eye-off]" : "icon-[mdi--eye]"}></i>
          ...
          <article class="rounded-xl border border-gray-200 bg-white p-6 shadow-sm">
            <header class="mb-6 flex items-center gap-3">
              ...
              <h2 class="text-xl font-bold text-gray-900">System Permissions</h2>
            </header>
              ...
              {#each staff_permissions as permission}
                <label class="label ml-3 text-sm text-gray-700 capitalize">
                  <input
                    ...
                    disabled={!edit_mode}
                    class="checkbox rounded {edit_mode ? 'border-gray-300' : 'border-gray-100'}"
                  />
