  ...
  <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
    ...
    <div class="text-center mb-16">
      ...
      <p class="mt-4 text-gray-600 max-w-3xl mx-auto">
        Scale your school management with plans designed to grow with your
        institution. From small classrooms to large districts, we have you
        covered.
      </p>
    </div>
    ...
    <div class="grid md:grid-cols-2 lg:grid-cols-3 gap-5 xl:gap-16 mb-16">
      {#each await get_plans() as plan}
        <div
          class="relative bg-white rounded-2xl shadow-lg border-2 {plan.color}"
        >
          {#if plan.popular}
            <div class="absolute -top-4 left-1/2 transform -translate-x-1/2">
              <span class="bg-gradient-to-r from-purple-500 to-pink-500 badge">
                Most Popular
              </span>
            </div>
          {/if}
    ...
    <div class="max-w-4xl mx-auto">
      <h2 class="text-xl font-bold text-center text-gray-900 mb-12">
